...
public class TypeCommand implements ITypeCommand{
    @Override
    public void execute(BufferedReader bufferedReader, HashMap<String, Value> map, ConcurrentHashMap<String, HashMap<String, String>> streamMap, OutputStream out) throws IOException {
